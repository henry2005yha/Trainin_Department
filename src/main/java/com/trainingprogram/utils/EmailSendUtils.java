...
public class EmailSendUtils {
	...
	public void SendEmail(CourseRegister userInfo) {
		...
		final String username = "henryyehtet@gmail.com";
		final String password = "yvbndwbnzinzvaim"; // app code copy and past here
		...
		try {
			...
			message.setFrom(new InternetAddress("henryyehtet@gmail.com"));
