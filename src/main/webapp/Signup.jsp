					...
					<form action="register"
						...
						<div class="mb-3">
							<label for="name" class="form-label">Name</label> <input required
								...
								placeholder="Ye Htet Aung" />
						</div>

						<div class="mb-3">

							<label for="email" class="form-label">Email</label> <br><p style="color:red;"><%=(request.getAttribute("Message") == null) ? ""

		: request.getAttribute("Message")%></p><input required type="email"
